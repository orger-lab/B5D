...
// FIXME ...
static const uint LOG2_MAX_SYMBOL_BITS = 16;
...
void HuffmanTableCPU::writeToBitStream(BitStream& bitstream) const
{
    ...
    const uint log2HuffmanDistinctSymbolCountMax = LOG2_SYMBOL_COUNT_MAX;
    ...
    bitstream.writeBits(symbolBits, longSymbols ? LOG2_MAX_SYMBOL32_BITS : LOG2_MAX_SYMBOL16_BITS);
    for(uint i = 0; i < m_symbols.size(); i++) {
