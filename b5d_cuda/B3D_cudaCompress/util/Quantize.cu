...
void symbolize(ushort* dpSymbols, const ushort* dpData, uint sizeX, uint sizeY, uint sizeZ, uint rowPitchSrc, uint slicePitchSrc)
{
	if (rowPitchSrc == 0) rowPitchSrc = sizeX;
	if (slicePitchSrc == 0) slicePitchSrc = rowPitchSrc * sizeY;
...
void unsymbolize(ushort* dpData, const ushort* dpSymbols, uint sizeX, uint sizeY, uint sizeZ, uint rowPitchDst, uint slicePitchDst)
{
	if (rowPitchDst == 0) rowPitchDst = sizeX;
