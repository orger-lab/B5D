...
#include "HuffmanTable.h" // this originally wanted cudaCompress/HuffmanTable.h
#include <cudaCompress/Timing.h>

#include "profiler/profiler.hpp" // this originally wanted cudaCompress/profiler/profiler.hpp
