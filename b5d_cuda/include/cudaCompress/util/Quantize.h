...
CUCOMP_DLL void symbolize(ushort* dpSymbols, const ushort* dpData, uint sizeX, uint sizeY, uint sizeZ, uint rowPitchSrc = 0, uint slicePitchSrc = 0);
CUCOMP_DLL void unsymbolize(ushort* dpData, const ushort* dpSymbols, uint sizeX, uint sizeY, uint sizeZ, uint rowPitchDst = 0, uint slicePitchDst = 0);
